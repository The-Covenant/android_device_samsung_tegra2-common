...
# Graphics
BOARD_EGL_CFG := device/samsung/tegra2-common/configs/egl.cfg
...
BOARD_CHARGER_RES := device/samsung/tegra2-common/res/charger

# EMMC brickbug is removed in the kernel, but be better safe than sorry.
BOARD_SUPPRESS_EMMC_WIPE := true

# Recovery
TARGET_RECOVERY_INITRC := device/samsung/tegra2-common/recovery.rc
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/samsung/tegra2-common/recovery/recovery_keys.c
BOARD_CUSTOM_GRAPHICS := ../../../device/samsung/tegra2-common/recovery/graphics.c
